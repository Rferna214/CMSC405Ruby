...
# Each of theses statements illustrates a method being called.
# The things before the period is referred to as the receiver.
...
# Write the lines of code that tells us the class of "Jin Joint" and the methods available to it.
...
# don't modify the state of the object They make a copy of the object and the modify the copy.
str = "Jin Joint"
upStr = str.upcase
puts upStr
puts str
